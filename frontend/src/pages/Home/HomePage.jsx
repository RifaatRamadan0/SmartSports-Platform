...
function PitchThumbnail({ sport }) {
  const s = (sport || '').toLowerCase()
  return (
    <div className="relative h-40 bg-gradient-to-br from-[oklch(0.32_0.12_145)] to-[oklch(0.20_0.08_145)] flex items-center justify-center">
